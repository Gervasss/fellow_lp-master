...
const useResizeObserver = (
  ...
  // The caller composes these dependencies so the observer can be reused across axis/layout modes.
...
const useImageLoader = (
  ...
  // Image loading depends on the caller-provided logo/layout inputs.
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, dependencies);
};
